...
Ar.prototype.getReadyCount = function () {
  return (0, _keys2.default)(this.s.allReady).length;
};
...
Ar.prototype._allComplete = function () {
  return (0, _keys2.default)(this.s.allPrepare).length === (0, _keys2.default)(this.s.allReady).length;
};
...
util.typeof = function (a) {
  var b = typeof a === 'undefined' ? 'undefined' : (0, _typeof3.default)(a);
